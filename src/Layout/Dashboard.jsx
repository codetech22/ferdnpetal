...
// import logo from '../logo/btslogo.avif'
...
//   <nav class="mt-6 relative max-w-7xl w-full bg-white border-2 border-purple-500 border-gray-200 rounded-[36px] mx-2 py-3 px-4 md:flex md:items-center md:justify-between md:py-0 md:px-6 lg:px-8 xl:mx-auto dark:bg-gray-800 dark:border-gray-700" aria-label="Global">
//     <div class="flex items-center justify-between">
//     <NavLink to={"/Home"}>  <div> 
//     <ul className='flex gap-1'>
//      <li><div><a class="flex-none text-xl font-bold dark:text-white" href="#" aria-label="Brand">BTS</a></div> </li>
//    <li className='  '><div><img src={logo} alt="" width={35}/></div> </li>
//     </ul>
//       </div> </NavLink>
//       <div class="md:hidden">
...
//       <NavLink to={"/Home"}> <a class="font-medium text-blue-600 md:py-6 dark:text-blue-500 hover:text-pink-500" href="#">Home</a></NavLink>
//        <NavLink to={"/Home"}> <a class="font-medium text-blue-600 md:py-6 dark:text-blue-500 hover:text-pink-500" href="#">Account</a></NavLink>
//         <a class="font-medium text-blue-600 md:py-6 dark:text-blue-500 hover:text-pink-500" href="#">Work</a>
//         <a class="font-medium text-blue-600 md:py-6 dark:text-blue-500 hover:text-pink-500" href="#">Blog</a>

//         <div class=" md:[--strategy:fixed] [--adaptive:none] md:[--trigger:hover] md:py-4">
//           <button type="button" class="flex items-center w-full font-medium text-blue-600 md:py-6 dark:text-blue-500 hover:text-pink-500">
//             Dropdown
...
const Dashboard = () => {
  return (
    <div>
      <header class="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-[#eeeee4] border-b border-gray-200 text-sm py-3 sm:py-0 dark:bg-gray-800 dark:border-gray-700">
  <nav class="relative max-w-7xl w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8" aria-label="Global">
    ...
    <NavLink to={"/Home"}>  <div> 
     <ul className='flex gap-1'>
      <li><div><a class="flex-none text-xl font-bold dark:text-white italic hover:not-italic text-yellow-950" href="#" aria-label="Brand">Fern&nbsp;And&nbsp;Petal</a></div> </li>
    <li className='  '><div><img src={logo} alt="" width={35}/></div> </li>
     </ul>
       </div> </NavLink>
      <div class="sm:hidden">
    ...
    <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block">
      ...
      <NavLink to={"/Home"}>  <a class="font-medium text-blue-600 sm:py-6 dark:text-blue-500 hover:text-pink-500" href="#" aria-current="page">Chocolates</a></NavLink>
       <NavLink to={"/gift"}> <a class="font-medium text-blue-600 sm:py-6 dark:text-blue-500 hover:text-pink-500" href="#">Gifts</a></NavLink>
       <NavLink to={"/teddy"}> <a class="font-medium text-blue-600 sm:py-6 dark:text-blue-500 hover:text-pink-500" href="#">Teddy</a></NavLink>
        <a class="font-medium text-blue-600 sm:py-6 dark:text-blue-500 hover:text-pink-500" href="#">Blog</a>

        <div class=" [--strategy:static] sm:[--strategy:fixed] [--adaptive:none] sm:[--trigger:hover] sm:py-4">
          <button type="button" class="flex items-center w-full font-medium text-blue-600 sm:py-6 dark:text-blue-500 hover:text-pink-500 ">
            Dropdown
            {/* hs-dropdown-menu  */}
